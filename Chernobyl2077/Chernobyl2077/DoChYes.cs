...
namespace Chernobyl2077
{
    class DoChYes
    {
        public static void DchY()
        {
            Console.WriteLine("*You walk in the room");
            Console.ReadKey();
            Console.WriteLine("*The door behind you closes");
            Console.ReadKey();
            Console.WriteLine("*You're in a big empty room");
            Console.ReadKey();
            Console.WriteLine("*You realise what this might be");
            Console.ReadKey();
            Console.WriteLine("*You hear music start playing");
            Console.ReadKey();
            Console.WriteLine("*You recognize the music, it's Dark Souls music");
            Console.ReadKey();
